  ...
  return (
    <div className="interest__container">
      <div className="head__interests">
        <div>Enow, you’re in! Select your interests</div>
        <p>Last! Pick at least one topic that you are interested in</p>
      </div>
      ...
      <div className="interest__wrapper">
        {interests.map((interest) => (
          <Interestbtn interest={interest} handleInterest={handleInterest} />
        ))}
      </div>
