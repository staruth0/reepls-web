...
function Interests() {
  ...
  return (
    <div className="interest__container">
      ...
      <div className={`counter__interests ${interest.length > 0 ? 'green' : null}`}>{interest.length} Selected</div>
      ...
      <div className="interest_btns">
        {updateUser.isPending ? (
          <button className={`${interest.length > 0 ? 'green' : null}`}>Completing Account Creation.......</button>
        ) : (
