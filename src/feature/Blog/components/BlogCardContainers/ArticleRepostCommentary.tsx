...
const ArticleNormalCommentary:React.FC<articleprobs> = ({article}) => {
  ...
  return (
    <>   <div className="">
      ...
      />
      <div className='p-2 text-[14px]'> Lorem ipsum dolor sit amet consectetur adipisicing elit.  quae nesciunt quis natus vel molestiae facilis, ipsam minus illo. Ducimus, ea.
  </div>
