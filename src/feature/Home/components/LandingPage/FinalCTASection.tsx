...
const FinalCTASection = () => {
  ...
  return (
    <section className={`${SECTION_PADDING_Y} bg-primary-50`}>
      <div className={SECTION_CONTENT_CLASS}>
        <div className="flex flex-col gap-8 md:gap-12 lg:gap-[48px] items-center">
          <div className="flex flex-col gap-3 items-center max-w-[600px] text-center">
            <h2 className="font-medium leading-tight min-[900px]:leading-[1.18] text-foreground text-xl sm:text-2xl md:text-3xl lg:text-4xl min-[900px]:text-[45px] tracking-[0px]">
            ...
            <div className="flex flex-row gap-3 items-center mt-3 w-full max-w-[420px]">
              <button
